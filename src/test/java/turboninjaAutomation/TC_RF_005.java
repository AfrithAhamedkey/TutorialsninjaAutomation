...
public class TC_RF_005 {
	...
	@Test
	public void verifyRegisteringNewsletterFieldSelectedYes() throws InterruptedException {
		...
		Assert.assertTrue(driver.findElement(By.xpath("//h1[text()='Newsletter Subscription']")).isDisplayed());
